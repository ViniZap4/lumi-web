...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .preview-content :global(h1) { color: #fbbf24; font-size: 2em; margin: 1em 0 0.5em; font-weight: 700; }
  .preview-content :global(h2) { color: #60a5fa; font-size: 1.5em; margin: 1em 0 0.5em; font-weight: 600; }
  .preview-content :global(h3) { color: #34d399; font-size: 1.25em; margin: 1em 0 0.5em; font-weight: 600; }
  .preview-content :global(code) { background: #1a1a1a; padding: 0.2em 0.4em; border-radius: 3px; color: #f87171; font-family: 'SF Mono', monospace; }
  ...
  .preview-content :global(strong) { font-weight: 600; color: #fff; }
  .preview-content :global(em) { font-style: italic; color: #d4d4d4; }
  .preview-content :global(blockquote) { border-left: 4px solid #404040; padding-left: 1em; color: #a3a3a3; margin: 1em 0; }
  .preview-content :global(ul), .preview-content :global(ol) { padding-left: 2em; margin: 1em 0; }
